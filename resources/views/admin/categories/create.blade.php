    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="justify-start m-2 p-2">
                <h4 class="text-2xl font-bold dark:text-white">Create New Category</h4>
            </div>
            ...
            <div class="m-2 p-2 bg-slate-100 rounded-lg">
                <div class="space-y-8 divide-y divide-gray-200 w-full mt-10">
                    <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-2 p-3">
                            <button type="submit"
                                class="px-3 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Store</button>
                        </div>
                    </form>
                </div>
            </div>
